  ...
  return (
    <div className="max-w-md mx-auto mt-16 animate-fade-in">
      <div className="text-center mb-8">
        ...
        <p className="mt-2 text-text-secondary">Start organizing your brain dumps for free</p>
      </div>

      <form onSubmit={handleSubmit} className="bg-bg-secondary border border-border-default rounded-xl p-8 space-y-5 shadow-xl">
        <div>
